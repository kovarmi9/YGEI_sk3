...
MyImg=randi(255,16,16,3);

Resample.MyDResampleNN(MyImg);
Resample.MyUResampleNN(MyImg);
Resample.MyDResample2X2(MyImg);
Resample.MyUResample2X2(MyImg);
Resample.MyDResample3X3(MyImg);
