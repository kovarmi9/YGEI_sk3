...
[idx, centroids_builtin] = kmeans(M, k, 'MaxIter', max_iter);

% Plot built-in KMeans centroids in black
plot(centroids_builtin(:, 1), centroids_builtin(:, 2), 'ko', 'MarkerSize', 12, 'LineWidth', 2);
...
disp('Built-in KMeans Centroids:');
disp(centroids_builtin);